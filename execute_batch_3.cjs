...
const BATCH_1 = ['aether-gazer', 'arknights-endfield', 'blood-strike', 'delta-force', 'fc-mobile', 'lol', 'lolwr', 'mccg', 'nikke', 'pubgm', 'wuwa'];
...
const OBSOLETE_DIR = path.join(__dirname, 'scratch/backup_assets/obsolete_batch3');
