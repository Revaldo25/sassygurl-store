    ...
    <div className="min-h-screen bg-[#09090b] text-white flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-16">
        <div className="relative w-full max-w-md overflow-hidden rounded-[2.5rem] border border-status-danger/10 bg-zinc-900/40 p-8 text-center backdrop-blur-3xl shadow-2xl">
          ...
          <h2 className="text-2xl font-black tracking-tight mb-2">Layanan Terganggu</h2>
          <p className="text-sm text-white/50 mb-8 leading-relaxed">
            {error.message || "Gagal memuat katalog atau data dari backend. Silakan periksa apakah server backend API berjalan."}
          </p>
